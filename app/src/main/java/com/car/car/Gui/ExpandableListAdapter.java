...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private List<Cliente> _listDataHeader;
    private final Map<Cliente, List<Veiculo> > _listDataChild;

    public ExpandableListAdapter(Context context, List<Cliente> listDataHeader,
                                 Map<Cliente, List<Veiculo> > listChildData) {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        Veiculo child = (Veiculo) getChild(groupPosition, childPosition);
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        Cliente group = (Cliente) getGroup(groupPosition);
        ...
        lblListHeader.setText(group.getNome());
